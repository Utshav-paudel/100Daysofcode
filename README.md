...
We can see that welcome() function is running directly after importing side module in main script .
...
So the main use of ```python__name__=="__main__"``` is to import any module without running it functions directly.
